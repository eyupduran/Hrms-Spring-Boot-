...
public class EJJKPSPublicSoap
{
    ...
    public EJJKPSPublicSoap(){}

    public EJJKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public EJJKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        EJJExtendedSoapSerializationEnvelope envelope= new EJJExtendedSoapSerializationEnvelope(EJJExtendedSoapSerializationEnvelope.VER11);
